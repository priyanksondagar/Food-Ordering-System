...
public class FoodOrder extends javax.swing.JFrame {
    ...
    private void jbtnOrderMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbtnOrderMouseClicked
        ...
        String Sno=jtxtfieldSmall.getText();
        try{
        Class.forName("com.mysql.jdbc.Driver");
        Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/test","root","");
        PreparedStatement ps=conn.prepareStatement("Insert into test(Spizza) values(?)");
        ps.setString(1, Sno);
        int rs=ps.executeUpdate();
        if(rs==0)
        {
            jtxtfieldStatus.setText("not done");
        }
        else
        {
            jtxtfieldStatus.setText("done");
        }
        }
        catch(Exception e)
        {
            jtxtfieldStatus.setText("exception raised");
        }
